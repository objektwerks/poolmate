...
class View(conf: Config, model: Model) {
  ...
  val measurementsTab = new Tab { text = conf.getString("measurements"); closable = false; content = measurementPane }
  ...
  val surfacesTab = new Tab { text = conf.getString("surfaces"); closable = false; content = surfacePane }

  val timerPane = new TimerPane(conf, model)
  val timersTab = new Tab { text = conf.getString("timers"); closable = false; content = timerPane }

  val pumpPane = new PumpPane(conf, model)
  val pumpsTab = new Tab { text = conf.getString("pumps"); closable = false; content = pumpPane }
