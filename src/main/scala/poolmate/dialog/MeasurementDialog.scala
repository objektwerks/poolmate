...
class MeasurementDialog(conf: Config, measurement: Measurement) extends Dialog[Measurement] {
  ...
  val tempSlider = new Slider {
    prefWidth = 600; min = 0; max = 100; majorTickUnit = 10; showTickLabels = true; showTickMarks = true; value = measurement.temp
  }
  val tempLabel = new Label {
    text = measurement.temp.toString
  }
  val tempControl = new HBox {
    spacing = 3; children = List(tempSlider, tempLabel)
  }

  val hardnessSlider = new Slider {
    prefWidth = 600; min = 0; max = 1000; majorTickUnit = 100; showTickLabels = true; showTickMarks = true; value = measurement.hardness
  }
  val hardnessLabel = new Label {
    text = measurement.hardness.toString
  }
  val hardnessControl = new HBox {
    spacing = 3; children = List(hardnessSlider, hardnessLabel)
  }

  val totalChlorineSlider = new Slider {
    prefWidth = 600; min = 0; max = 10; majorTickUnit = 1; showTickLabels = true; showTickMarks = true; value = measurement.totalChlorine
  }
  val totalChlorineLabel = new Label {
    text = measurement.totalChlorine.toString
  }
  val totalChlorineControl = new HBox {
    spacing = 3; children = List(totalChlorineSlider, totalChlorineLabel)
  }

  val bromineSlider = new Slider {
    prefWidth = 600; min = 0.0; max = 20; majorTickUnit = 1; showTickLabels = true; showTickMarks = true; value = measurement.bromine
  }
  val bromineLabel = new Label {
    text = measurement.bromine.toString
  }
  val bromineControl = new HBox {
    spacing = 3; children = List(bromineSlider, bromineLabel)
  }

  val freeChlorineSlider = new Slider {
    prefWidth = 600; min = 0; max = 10; majorTickUnit = 1; showTickLabels = true; showTickMarks = true; value = measurement.freeChlorine
  }
  val freeChlorineLabel = new Label {
    text = measurement.freeChlorine.toString
  }
  val freeChlorineControl = new HBox {
    spacing = 3; children = List(freeChlorineSlider, freeChlorineLabel)
  }

  val phSlider = new Slider {
    prefWidth = 600; min = 6.2; max = 8.4; majorTickUnit = 0.2; showTickLabels = true; showTickMarks = true; value = measurement.pH
  }
  val phLabel = new Label {
    text = doubleFormatter.format(measurement.pH)
  }
  val phControl = new HBox {
    spacing = 3; children = List(phSlider, phLabel)
  }

  val alkalinitySlider = new Slider {
    prefWidth = 600; min = 0; max = 240; majorTickUnit = 20; showTickMarks = true; showTickLabels = true; value = measurement.alkalinity
  }
  val alkalinityLabel = new Label {
    text = measurement.alkalinity.toString
  }
  val alkalinityControl = new HBox {
    spacing = 3; children = List(alkalinitySlider, alkalinityLabel)
  }

  val cyanuricAcidSlider = new Slider {
    prefWidth = 600; min = 0; max = 300; majorTickUnit = 25; showTickLabels = true; showTickMarks = true; value = measurement.cyanuricAcid
  }
  val cyanuricAcidLabel = new Label {
    text = measurement.temp.toString
  }
  val cyanuricAcidControl = new HBox {
    spacing = 3; children = List(cyanuricAcidSlider, cyanuricAcidLabel)
  }
