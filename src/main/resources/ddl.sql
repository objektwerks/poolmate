...
create table "measurements" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"pool_id" INTEGER NOT NULL,"on" DATE NOT NULL,"ch" INTEGER NOT NULL,"ph" INTEGER NOT NULL,"alky" INTEGER NOT NULL,"temp" INTEGER NOT NULL)
create table "additions" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"pool_id" INTEGER NOT NULL,"on" DATE NOT NULL,"tablets" INTEGER NOT NULL,"ch" INTEGER NOT NULL)
...
alter table "additions" add constraint "pool_addition_fk" foreign key("pool_id") references "pools"("id") on update NO ACTION on delete NO ACTION