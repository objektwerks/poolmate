...
create table "chemicals" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"name" VARCHAR NOT NULL)
create table "additives" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"pool_id" INTEGER NOT NULL,"chemical_id" INTEGER NOT NULL,"on" DATE NOT NULL,"amount" VARCHAR NOT NULL)
