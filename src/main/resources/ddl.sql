...
create table "additives" ("id" INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,"pool_id" INTEGER NOT NULL,"on" DATE NOT NULL,"name" VARCHAR NOT NULL,"kind" VARCHAR NOT NULL,"amount" VARCHAR NOT NULL)
